 ...
 *
 */
class vboxwebmgrAuthMySQL implements vboxwebmgrAuth
{
	...
	function newPDO()
	{
		...
		}catch (PDOException $e){throw new Exception("Can't connect to MySQL db!",vboxconnector::VBWEBMGR_ERRNO_CONNECT);}
	}
	...
	function PDO_selectUser($username)
	{
		try{
			...
			$statement->execute();
		}catch(PDOException $e){throw new Exception("Can't execute requested query!",vboxconnector::VBWEBMGR_ERRNO_FATAL);}
	...
	function listUsers()
	{
		...
		try{
			...
			$sth->execute();
		}catch(PDOException $e){throw new Exception("Can't display users list!",vboxconnector::VBWEBMGR_ERRNO_FATAL);}
