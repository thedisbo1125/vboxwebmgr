<?php
/**
 * Interface for vboxwebmgr authentication modules
 *
 ...
 *	}
 *
 * Implementing classes should be prefixed with vboxwebmgrAuth. E.g.
 * vboxwebmgrAuthMySiteAuth. authLib in config.php would then be set
 * to 'MySiteAuth'
 */
interface vboxwebmgrAuth {
