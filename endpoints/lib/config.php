<?php
/**
 * vboxwebmgr configuration class. Parses user configuration, applies
...
class vboxwebmgrConfigClass {
	...
	/**
	 * Exclusively use vboxwebmgr groups rather than
	 * VirtualBox groups
	 */
	var $vboxwebmgrGroups = false;
	 ...
	 * instantiation of vboxwebmgrConfigClass.
	 * Set in __construct()
	 * @var string
	 */
	var $key = null;
	 ...
	 * Set in __construct
	 * @var vboxwebmgrAuthBuiltin::authCapabilities
	 */
	...
	function __construct() {
		...
		if(class_exists('vboxwebmgrConfig')) {
			$c = new vboxwebmgrConfig();
		...
		$alib = "vboxwebmgrAuth{$this->authLib}";
